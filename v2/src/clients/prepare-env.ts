...
/** Env vars for browser/viewport — client layer; connect mode comes from env only. */
...
export function resolveBrowserApplianceUrl(): string | undefined {
  return process.env['BROWSER_CDP_URL']?.trim() || undefined;
}
